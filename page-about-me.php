 ...
 *
 * This is the template controls the about page layout.
 *
  ...
  <article class="container">
    <div class="row flex-row-reverse py-5">
      <div class="col-12 col-md-6 d-flex justify-content-center align-items-center">
        <img class="about-page-profile-picture img-fluid shadow rounded" src="<?php echo get_template_directory_uri() . '/images/craigwatson-profile-picture.jpg' ?>" alt="A profile picture of Craig Watson">
      </div>
      <div class="col-12 col-md-6 d-flex justify-content-center align-items-center">
    ...
    <div class="row align-items-stretch py-5">
      ...
      <div class="col-12 col-lg-4">
        <div class="things-to-know bg-primary rounded d-flex flex-column h-100 p-5" id="ttk-family">
      ...
      <div class="col-12 col-lg-4">
        <div class="things-to-know bg-info text-secondary rounded d-flex flex-column h-100 p-5" id="ttk-granddad">
      ...
      <div class="col-12 col-lg-4">
        <div class="things-to-know rounded d-flex flex-column h-100 p-5" id="ttk-sport">
    ...
    <div class="row py-5">
      ...
      <div class="col-12 col-lg-9">
        <div class="current-skills bg-secondary rounded position-relative p-5 mb-5">
          ...
          <div class="progress-dashes">
            <div class="progress-dash bg-primary me-2"></div>
            <div class="progress-dash bg-primary me-2"></div>
            <div class="progress-dash bg-primary me-2"></div>
            <div class="progress-dash bg-primary me-2"></div>
    ...
    <div class="row py-5">
      <div class="p-5 bg-secondary shadow rounded">
      <div class="col-12 mb-5">
      ...
      <div class="col-12 mb-5">
        ...
        <div class="d-flex flex-wrap">
          <a class="btn btn-outline-primary me-3" href="https://github.com/atcraigwatson">Github</a>
          <a class="btn btn-outline-primary me-3" href="https://codepen.io/atcraigwatson">Codepen</a>
          <a class="btn btn-outline-primary me-3" href="/contact-me">Email Me</button>
          <a class="btn btn-outline-primary" href="/projects">Recent Projects</a>
        </div>
      </div>
      </div>
    </div>
